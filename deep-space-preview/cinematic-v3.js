...
// Much wider protected viewing envelopes. These are intentionally generous so
// the camera reads as a distant orbital observer instead of a fly-through camera.
const subjects=[
  {c:V(0,-2,0),r:62},
  {c:V(-5,1.8,-47),r:38},
  {c:V(4,-1.4,-68),r:30},
...
// Every hero encounter is now staged as a wide three-quarter composition.
// Position changes stay on broad arcs, with no crossing through a subject's near side.
const shots=[
